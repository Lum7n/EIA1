// Deklarierung 
var cardStack = []; // ungemischt
var playerCards = []; // Array Spielerkarten
var computerCards = []; // Array Gegnerkarten
var activeCards = []; // Array für Spielstapel
var currentCard; // aktuelle Karte auf Ablagestapel
var currentPlayer; // zeigt an, ob der Spieler gerade Spielzüge ausführen darf oder ob der Gegner dran ist
var alreadyTookCard = false; // zeigt an, ob schon eine Karte aufgenommen wurde
...
function opponent() {
    var couldLay = false; // zeigt an, ob der Gegner eine Karte legen konnte
