...
function playSample(file): void {
    var sound: HTMLAudioElement = new Audio("sounds/" + file);
    sound.play();
}
...
function start_beat() {
    var beat: string[] = ["sounds/kick.mp3", "sounds/snare.mp3", "sounds/kick.mp3", "sounds/kick.mp3", "sounds/hihat.mp3"]
    var index: number = 0;
